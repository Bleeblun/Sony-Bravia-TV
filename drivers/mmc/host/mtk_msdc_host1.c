...
static int msdc1_probe(struct platform_device *pdev)
{
    ...
    mmc->ops = &msdc1_ops;
    mmc->f_min = 397000;
#if (defined(CC_MT5399) || defined(CONFIG_ARCH_MT5399) || defined(CC_MT5890) || defined(CONFIG_ARCH_MT5890) || defined(CC_MT5882) || defined(CONFIG_ARCH_MT5882)) && defined(CC_EMMC_HS200)
    mmc->f_max = 200000000;
#else
    mmc->f_max = 52000000;
#endif
