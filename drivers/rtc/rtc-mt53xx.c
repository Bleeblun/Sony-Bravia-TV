...
#define PDWNC_YEAR (PDWNC_VIRT+0x700)
#define PDWNC_MONTH (PDWNC_VIRT+0x704)
#define PDWNC_DAY (PDWNC_VIRT+0x708)
#define PDWNC_WEEK (PDWNC_VIRT+0x70C)
#define PDWNC_HOUR (PDWNC_VIRT+0x710)
#define PDWNC_MINUTE (PDWNC_VIRT+0x714)
#define PDWNC_SECOND (PDWNC_VIRT+0x718)
#define PDWNC_AYEAR (PDWNC_VIRT+0x71C)
#define PDWNC_AMONTH (PDWNC_VIRT+0x720)
#define PDWNC_ADAY (PDWNC_VIRT+0x724)
#define PDWNC_AWEEK (PDWNC_VIRT+0x728)
#define PDWNC_AHOUR (PDWNC_VIRT+0x72C)
#define PDWNC_AMINUTE (PDWNC_VIRT+0x730)
#define PDWNC_ASECOND (PDWNC_VIRT+0x734)
#define PDWNC_ALMINT (PDWNC_VIRT+0x738)
#define PDWNC_RTCCTL (PDWNC_VIRT+0x73C)
#define PDWNC_LEAPYEAR (PDWNC_VIRT+0x744)
#define PDWNC_PROT (PDWNC_VIRT+0x748)
#define PDWNC_INTSTA (PDWNC_VIRT + 0x041)
#define PDWNC_ARM_INTEN (PDWNC_VIRT + 0x045)
#define PDWNC_INTCLR (PDWNC_VIRT + 0x049)
/* Bits in the Interrupts register */
    #define RTC_INT 0x10//[12]
#define PDWNC_WKRSC (PDWNC_VIRT + 0x108)
#define PDWNC_WAKEN (PDWNC_VIRT + 0x120)
