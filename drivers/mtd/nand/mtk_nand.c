...
#if !defined(CONFIG_ARCH_MT5398) && !defined(CONFIG_ARCH_MT5399) && !defined(CONFIG_ARCH_MT5880) && !defined(CONFIG_ARCH_MT5860) && !defined(CONFIG_ARCH_MT5890)&& !defined(CONFIG_ARCH_MT5861)&& !defined(CONFIG_ARCH_MT5882)
...
#endif
#if defined(CONFIG_ARCH_MT5399) ||  defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5861)|| defined(CONFIG_ARCH_MT5882)
    NAND_IO_WRITE32(0xf000d48c, NAND_IO_READ32(0xf000d48c) & 0x8E38E3FF);//WE driving clear
    NAND_IO_WRITE32(0xf000d490, NAND_IO_READ32(0xf000d490) & 0xE38E38E3);//pin driving clear

    NAND_IO_WRITE32(0xf000d48c, NAND_IO_READ32(0xf000d48c) | 0x10410400);//WE driving setting
    NAND_IO_WRITE32(0xf000d490, NAND_IO_READ32(0xf000d490) | 0x04104104);//pin driving setting

    NAND_IO_WRITE32(0xf000d540, NAND_IO_READ32(0xf000d540) | 0x1);//POOE driving
    NAND_IO_WRITE32(0xf000d550, NAND_IO_READ32(0xf000d550) & 0xFFFFFFFE);//POOE driving
    NAND_WRITE32(NAND_NFI_RANDOM_CFG, 0);
#if NAND_RANDOM_EN
...
void _NANDHW_CLKONOFF(BOOL fgOn)
{
    if(fgOn) //turn on clk
    {
        ...
        #elif defined(CONFIG_ARCH_MT5398) || defined(CONFIG_ARCH_MT5399) || defined(CONFIG_ARCH_MT5890) || defined(CONFIG_ARCH_MT5861)|| defined(CONFIG_ARCH_MT5882)
...
#if !defined(CONFIG_ARCH_MT5399) && !defined(CONFIG_ARCH_MT5398) && !defined(CONFIG_ARCH_MT5880) && !defined(CONFIG_ARCH_MT5860)&& !defined(CONFIG_ARCH_MT5890)&& !defined(CONFIG_ARCH_MT5861)&& !defined(CONFIG_ARCH_MT5882)
