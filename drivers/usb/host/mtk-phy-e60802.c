...
PHY_INT32 phy_init_e60802(struct u3phy_info *info){	
	...
	U3PhyWriteField32(((PHY_UINT32)&info->u3phya_da_regs_e->reg0)
		, E60802_RG_SSUSB_XTAL_EXT_EN_U3_OFST, E60802_RG_SSUSB_XTAL_EXT_EN_U3
		, 0x2);
    // RG_SSUSB_FRC_XTAL_RX_PWD = 1
	U3PhyWriteField32(((PHY_UINT32)&info->spllc_regs_e->u3d_xtalctl3)
...
//		, 0x3);
    ...
    if(IS_IC_MT5890_ES1())
    {
        ...
        U3PhyWriteField32(((PHY_UINT32)&info->u2phy_regs_e->usbphyacr1)
    ...
    else
    {
        ...
        U3PhyWriteField32(((PHY_UINT32)&info->u3phya_regs_e->regb)
