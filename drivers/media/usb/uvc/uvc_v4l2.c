...
int uvc_off_delay= 0;
module_param(uvc_off_delay, int, S_IRUGO | S_IWUSR);
MODULE_PARM_DESC(uvc_off_delay,"uvc stream_off delay times");
...
static long uvc_v4l2_do_ioctl(struct file *file, unsigned int cmd, void *arg)
{
	...
	case VIDIOC_STREAMOFF:
	{
		...
		/*20150501 Leon Kernel Crash in uvc_queue_next_buffer()/del_list 
		  * after do videoc_streamoff
		  * only happen for MJPEG video frame. 
		 */
		msleep(uvc_off_delay);
