...
#define WSW_VID 0x054c
#define WSW_PID 0x089f
...
extern void announce_camera(struct usb_device *udev, int connect);
extern int get_camera_1st_node(void);
extern void clean_camera_1st_node(void);
